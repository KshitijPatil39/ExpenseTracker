...
struct AccountDetails: View {
    ...
    var groupedTransactions: [String: [AccountsResponse.Transaction]] {
        if accountId == nil {
            ...
            return Dictionary(grouping: filteredTransactions, by: { $0.date })
        }
    ...
    static var previews: some View {
        ...
        let decoder = JSONDecoder()
                do {
                    ...
                    return AnyView(AccountDetails(transactions: .constant(transactions), accountId: "", accoutName: ""))
                } catch {
